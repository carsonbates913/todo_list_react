    ...
    <div className={`task ${active ? 'freeze' : ''}`}>
      ...
      <div className='task-section-properties'>
        <div className='icon-section'>
          <div className='icon-div' id='due-date-icon'>
            <svg className='task-icon' viewBox='0 0 448 512'>
              <path d='M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24l0 40L64 64C28.7 64 0 92.7 0 128l0 16 0 48L0 448c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-256 0-48 0-16c0-35.3-28.7-64-64-64l-40 0 0-40c0-13.3-10.7-24-24-24s-24 10.7-24 24l0 40L152 64l0-40zM48 192l352 0 0 256c0 8.8-7.2 16-16 16L64 464c-8.8 0-16-7.2-16-16l0-256z'/>
            </svg>
          </div>
          <div className='icon-div' id='work-time-icon'>
            <svg className='task-icon' viewBox='0 0 512 512'>
              <path d='M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z'/>
            </svg>
          </div>
          <div className='icon-div' id='progress-icon'>
            <svg className='task-icon' viewBox='0 0 512 512'>
          ...
          <div className='icon-div' id='category-icon'>
            <svg className='task-icon' viewBox='0 0 576 512'>
              <path d='M264.5 5.2c14.9-6.9 32.1-6.9 47 0l218.6 101c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 149.8C37.4 145.8 32 137.3 32 128s5.4-17.9 13.9-21.8L264.5 5.2zM476.9 209.6l53.2 24.6c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 277.8C37.4 273.8 32 265.3 32 256s5.4-17.9 13.9-21.8l53.2-24.6 152 70.2c23.4 10.8 50.4 10.8 73.8 0l152-70.2zm-152 198.2l152-70.2 53.2 24.6c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 405.8C37.4 401.8 32 393.3 32 384s5.4-17.9 13.9-21.8l53.2-24.6 152 70.2c23.4 10.8 50.4 10.8 73.8 0z'/>
            </svg>
          </div>
          <div className='icon-div' onClick={(event) => {handleTaskOptions(event)}}>
            <svg className='task-icon' viewBox='0 0 448 512'>
              <path d='M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z'/>
            </svg>
          </div>
        </div>
        <div className='property'>{task.details.dueDate || 'N.A'}</div>
        <div className='property'>{task.details.workTime || 'N.A'}</div>
        <div className='property'>{task.details.progress || 'N.A'}</div>
        <div className='property'>{task.details.tag || 'N.A'}</div>
      </div>
    </div>
  </>
}
