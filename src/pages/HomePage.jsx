...
function HomePage(){
  ...
  <TaskProvider>
      ...
      <div className='home-content'>
        ...
        <TaskModal isEditing={isEditing} handleEditing={()=>{setIsEditing(false)}} isActive={isTaskModalActive} onClose={()=>setTaskModalActive(false)}/>
      </div>
      <div className='popup-container'>
        <Popup id='task-options' isOpen={activePopup==='task-options'} position={popupPosition} onClose={handleClosePopup}>
          <TaskOptions onClose={handleClosePopup} onEdit={()=>{setIsEditing(true);setTaskModalActive(true);}}></TaskOptions>
        </Popup>
      </div>
      </TaskProvider>
  </>
